...
* rake db:migrate (only needed if your database isn't up to date)
  * or: bin/rake db:migrate
* rake sunspot:solr:start
  * or: bin/rake sunspot:solr:start
* rails s


TODO:

* redirect pages or somehow show a good error when forms fail
...
* make sure layouts in controllers are what we want them to be
