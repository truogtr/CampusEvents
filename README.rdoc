...
To run locally, run these from the root of the app:
...
* finish README (see suggestions below)
...
* get static files serving
  * http://stackoverflow.com/questions/14519997/actioncontrollerroutingerror-no-route-matches-get-assets-images-control-t
...
Is this needed?: bin/rake assets:precompile
